...
// create section and associates with a note
const createSection = async (req, res, next) => {
  ...
  //push widgets in a section --> adds array of widget ID to specific section
...
// Update a section, updates the layout field of a section identified by its ID
...
// Delete a section and its widgets --> ask user before!!
